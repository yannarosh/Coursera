rankhospital <- function(state, outcome, num = "best") {
        ...
        # turn inputs "best" and "worst" to integers indicating rank
        ...
        ## Return result hospital, which is found in the input row of the ordered subset
        ordered_subset[num, 1]
}